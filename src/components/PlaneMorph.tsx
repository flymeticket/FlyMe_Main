...
const frameCount = 211; // Based on dir output for sequence-2
const imageUrls = Array.from({ length: frameCount }, (_, i) => 
  `/sequence-2/ezgif-frame-${(i + 1).toString().padStart(3, '0')}.jpg`
);
    ...
    <div ref={containerRef} className="relative h-[400vh] bg-[#050505]">
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none">
          ...
          >
            <h2 className="text-white text-5xl md:text-7xl font-light tracking-widest mb-6">
              THE FLEET
            </h2>
            <p className="text-white/80 text-lg md:text-xl tracking-[0.2em] uppercase font-light">
